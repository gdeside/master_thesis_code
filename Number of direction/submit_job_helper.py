...
job_info = {
    "job_name": f"{type_analysis}_analysis_{method}",
    "time": "20:00:00",
    "ntasks": 1,
    "cpus_per_task": 1,
    "mem_per_cpu": 60000,
    ...
    "mail_type": "ALL",
    "output": f"{type_analysis}_analysis_{method}.txt",
    "script": "python3 reduced_number_of_directions.py"
    #"script": f"python3 patient_{method}.py"

}

sbatch_script_path = f"{type_analysis}_{method}.sbatch"
