...
# Example usage
job_info = {
    "job_name": "registration_find_ROI_nb_bundles",
    "time": "48:00:00",
    "ntasks": 1,
    "cpus_per_task": 1,
    "mem_per_cpu": 20000,
    ...
    "mail_type": "ALL",
    "output": "output_find_ROI_nb_bundles.txt",
    "script": "python3 find_ROI_nb_bundles.py"
}

sbatch_script_path = "submit_registration_find_ROI_nb_bundles.sbatch"
