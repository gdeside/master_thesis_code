...
# Example usage
job_info = {
    "job_name": "DTI_submission_mgh_1001_1010",
    "time": "48:00:00",
    "ntasks": 1,
    "cpus_per_task": 1,
    "mem_per_cpu": 40000,
    ...
    "mail_type": "ALL",
    "output": "output_DTI_mgh_1001_1010.txt",
    "script": "python3 patient_dti_analysis.py"
}

sbatch_script_path = "submit_DTI_mgh_1001_1010.sbatch"
